...
parser.add_argument('--data_dir', default='ds_pulmons_1ROI_original', help="Directory with the original dataset")
parser.add_argument('--output_dir', default='ds_pulmons_1ROI_resized', help="Where to write the new data")
