...
ds_path = '../../../../../../Deteccio_pulmons/v_2ROIs/Datasets/Dataset_train/subsetKaggleCOVID/original/train_val/' # path is related to where "effusion_classification_covid_v2" is located (it's the notebook that uses this library)
...
def setupLungsDetectionLearner():
    ...
    return learn.load('lungs_detector')